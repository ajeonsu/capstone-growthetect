...
export default function NutritionistProfilePage() {
  ...
  const loadUserData = async () => {
    try {
      ...
      if (data.success) {
        setUser(data.user);
        // Parse name into components (assuming name is "First Middle Last")
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <div className="text-center mb-8 pb-6 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-gray-800">{fullName || 'Nutritionist'}</h2>
              <p className="text-gray-500 mt-1">Nutritionist</p>
            </div>
