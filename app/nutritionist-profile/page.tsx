      ...
      <main className="md:ml-60 p-4 sm:p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative bg-white rounded-2xl shadow-md overflow-hidden mb-6">
            {/* Banner */}
            <div className="h-28 w-full" style={{ background: 'linear-gradient(135deg, #1a3a6c 0%, #16a34a 100%)' }} />
            {/* Avatar */}
            <div className="absolute top-12 left-1/2 -translate-x-1/2 w-24 h-24 rounded-full ring-4 ring-white bg-green-600 flex items-center justify-center shadow-lg">
              <span className="text-3xl font-bold text-white">{initials || '?'}</span>
            </div>
            <div className="pt-16 pb-6 text-center px-6">
              <h2 className="text-2xl font-bold text-slate-800">{fullName || 'Nutritionist'}</h2>
              <span className="inline-block mt-1 px-3 py-0.5 bg-green-100 text-green-700 text-xs font-semibold rounded-full">Nutritionist</span>
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden mb-6">
            ...
            <form onSubmit={handleUpdateProfile} className="p-6 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
                  />
                </div>
                <div>
              ...
              <div className="flex justify-end pt-2">
                <button type="submit" className="px-5 py-2.5 text-sm font-semibold bg-green-600 text-white rounded-xl hover:bg-green-700 shadow-sm transition">
                  Save Changes
                </button>
              </div>
            </form>
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden mb-6">
            ...
            <div className="p-6 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-semibold bg-blue-50 text-blue-700 border border-blue-200 rounded-xl hover:bg-blue-100 transition"
              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleChangePassword} className="p-6 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" className="px-5 py-2.5 text-sm font-semibold bg-blue-600 text-white rounded-xl hover:bg-blue-700 shadow-sm transition">
                  Update Password
                </button>
              </div>
            </form>
